...
class Image {
     ...
     * @return void
     */
    static function thumb($image, $thumbname, $type='', $maxWidth=200, $maxHeight=50, $interlace=false) {
        // 获取原图信息
    ...
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify') {
        ...
        $randval = StringNew::randString($length, $mode);
        session($verifyName, md5($randval.C("VERIFY_CONFLATION")));
    ...
    static function GBVerify($length=4, $type='png', $width=180, $height=50, $fontface='simhei.ttf', $verifyName='verify') {
        import('ORG.Util.StringNew');
        $code = StringNew::randString($length, 4);
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            $codex = StringNew::msubstr($code, $i, 1);
