...
return  array(
    ...
    /* 数据库设置 */
    'DB_TYPE'               =>  'mysql',     // 数据库类型
    'DB_HOST'               =>  '192.168.227.129', // 服务器地址
    'DB_NAME'               =>  'tp_framework',          // 数据库名
    'DB_USER'               =>  'root',      // 用户名
    'DB_PWD'                =>  'rpd',          // 密码
    'DB_PORT'               =>  '3306',        // 端口
    ...
    'SESSION_OPTIONS'       =>  array('expire' => 604800,), // session 配置数组 支持type name id path expire domain 等参数
